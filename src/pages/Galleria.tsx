...
import oracle_ai_foundations_eCertificate from "../assets/oracle_ai_foundations_eCertificate_(OCI25AICFA).jpeg";
import oracle_foundations_associate from "../assets/oracle_foundations_associate_(OCI25FNDCFA).jpeg";
...
function Galleria() {
  ...
  const images = [
    ...
    {
      url: oracle_ai_foundations_eCertificate,
      title: "Oracle AI Foundation Associate",
    },
    {
      url: oracle_foundations_associate,

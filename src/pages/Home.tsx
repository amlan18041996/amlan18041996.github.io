      ...
      <header className="min-h-screen relative flex items-center">
        ...
        <div className="container px-4 lg:px-28 2xl:px-36">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="text-sm font-mono mb-4 text-blue-400">Hello, I'm Amlan Sengupta</div>
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              <TypeEffect className="text-primary font-semibold" words={['Full Stack Developer', 'Frontend Developer', 'Backend Developer', 'Digital Strategist']}></TypeEffect>
            </h1>
            ...
            {featuredProjects.map((project, index) => (
              <div key={index} className={`group relative flex lg:block ${theme.contentBackground} p-2 lg:p-0 rounded-2xl overflow-hidden`}>
                ...
                <div className="pb-2 pl-4 lg:p-6">
                  <h3 className="text-xl font-bold mb-0 lg:mb-2">{project.title}</h3>
